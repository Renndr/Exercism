...
public class DartsTest {
    ...
    //Main method because i dont know how to execute test without getting an error at this moment 
    public static void main(String[] args) {
        DartsTest test = new DartsTest();
        test.missedTarget();
        //test.onTheOuterCircle();
        //test.onTheMiddleCircle();
    }
