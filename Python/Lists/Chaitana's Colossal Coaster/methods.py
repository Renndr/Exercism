...
#print(add_me_to_the_queue(express_queue=["Tony", "Bruce"], normal_queue=["RobotGuy", "WW"], ticket_type=1, person_name="HawkEye"))
...
def find_my_friend(queue, friend_name):
    ...
    if(friend_name in queue):
        ...
        return Exception(friend_name + " is not in list")


#print(find_my_friend(queue=["Natasha", "Steve", "T'challa", "Wanda", "Rocket"], friend_name="Steves"))
...
#print(add_me_with_my_friends(queue=["Natasha", "Steve", "T'challa", "Wanda", "Rocket"], index=0, person_name="Bucky"))
