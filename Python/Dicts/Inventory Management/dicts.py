...
def list_inventory(inventory):
    ...
    #return a list containing all (item_name, item_count) pairs in inventory, if count == 0 remove item from inventory
...
def __main__():
    ...
    #print(add_items({"coal":10,"rock":30}, ["wood", "iron", "coal", "wood"]))
